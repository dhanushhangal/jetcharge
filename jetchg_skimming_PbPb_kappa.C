...
void jetchg_skimming_PbPb_kappa(bool doCrab=0, int jobID=0, int endfile = 3203, int dataset_type_code = 2, int output_file_num = 1)
{
	bool is_pp = false;
	...
	while(instr>>filename && ifile<endfile){
        ...
        //TFile *my_file = TFile::Open("HiForestAOD_P+H_new.root");
